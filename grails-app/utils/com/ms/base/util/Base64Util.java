...
public class Base64Util {
	...
	public static void main(String[] args) throws Exception {
		String data = "00-50-56-C0-00-08";
		String key = "rosten!@#$%";
		System.err.println(encode(data, key));
		System.err.println(decode(encode(data, key), key));
	 ...
	 * @throws Exception
	 */
	public static String decode(String data, String key) throws IOException,
			Exception {
		if (data == null)
			return null;
