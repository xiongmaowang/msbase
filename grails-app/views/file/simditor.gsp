...
<body>
	<form action="${request.getContextPath()}/public/editorSave" method="post">
   		<ueditor:editor id="editor" style="width:100%;height:360px;">Hello World</ueditor:editor>
...
<%--http://ueditor.baidu.com/website/onlinedemo.html
		https://github.com/hhxiao/grails-ueditor/
		
		http://blog.csdn.net/sikaodeluwei/article/details/17507209
	--%>