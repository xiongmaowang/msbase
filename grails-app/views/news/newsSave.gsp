    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <g:form url="[action:'newsSave',controller:'news']" class="form-horizontal" useToken="true" id="msForm">
								...
								<div class="row">
									<div class="col-md-4">
										<input type="text" class="form-control adduser" data-ms-validate data-ms-validate-isnotnull
											   required placeholder="请输入标题" name="topic" value="${news.topic}">
										<span class="glyphicon glyphicon-user form-control-feedback" style="color:#23B7E5;"></span>
									</div>
									<div class="col-md-8">
										<span class="add_controlShow help-block">请输入标题</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-group has-default has-feedback">
					    <div class="form-group">
							<div>
                                <ueditor:resources/>
								<ueditor:editor id="editor" style="width:100%;height:360px;" name="content">${news.content}</ueditor:editor>
